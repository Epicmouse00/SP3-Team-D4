...
public:
	...
	// Returns true if the jump key is held after initial jump
	bool isJumpKeyHeld(void);
	// Returns true if the double jump has been triggered
	bool isDoubleJump(void);
	...
	// Set the player to double jump
	void SetToDoubleJump(bool isOnDoubleJump);
...
private:
	...
	short m_sPlayerPosture;

	bool m_bPostureToggled;
